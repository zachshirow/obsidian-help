<<<<<<< HEAD:fa/Obsidian Publish/Set up a custom domain.md
You can set up a custom domain or subdomain for your [[مقدمه ای بر ابسیدین پابلیش|Obsidian Publish]] site.
=======

You can set up a custom domain or subdomain for your [[مقدمه‌ای بر اوبسیدین پابلیش|Obsidian Publish]] site.

>>>>>>> obsidianmd-master:fa/اوبسیدین پابلیش/راه‌اندازیِ دامنه‌ی دلخواه.md
