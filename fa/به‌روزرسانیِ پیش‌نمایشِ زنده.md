...
<<<<<<<< HEAD:fa/به روز رسانی نمایش زنده.md
If you want to know how the terminology changes with the new features, here's a handy chart by [[قدردانی#^a4b3a2|Argentum]]:
...
========
>>>>>>>> obsidianmd-master:fa/به‌روزرسانیِ پیش‌نمایشِ زنده.md
