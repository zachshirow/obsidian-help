...
Description: Opens [[جستجو]] in the specified vault, and optionally perform a search query.
...
- `obsidian://search?vault=my%20vault`
  This opens the vault `my vault`, and opens [[جستجو]].
- `obsidian://search?vault=my%20vault&query=MOC`
  This opens the vault `my vault`, opens [[جستجو]], and performs a search for `MOC`.
