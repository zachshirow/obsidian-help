...
| `task:`         | Find matches in a [[نحوِ قالب‌بندیِ پایه#Task lists|task]] on a block-by-block basis.<p/>Example: `task:call`.                                                                                                          |
| `task-todo:`    | Find matches in an *uncompleted* [[نحوِ قالب‌بندیِ پایه#Task lists|task]] on a block-by-block basis.<p/>Example: `task-todo:call`.                                                                                      |
| `task-done:`    | Find matches in a *completed* [[نحوِ قالب‌بندیِ پایه#Task lists|task]] on a block-by-block basis.<p/>Example: `task-done:call`.                                                                                         |
...
> [!note] توجّه
> [[مقدمه‌ای بر اوبسیدین پابلیش|Obsidian Publish]] doesn't support embedded search results. To see the example, open Obsidian Help locally inside Obsidian.
