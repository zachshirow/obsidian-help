...
To open the Graph view, click **Open graph view** in the [[روبان]].

- Circles represent notes, or _nodes_.
- Lines represents [[پیوندهای درونی]] between two nodes.
...
- **Search files** lets you filter notes based on a search query. To learn about how you can write more advanced search queries, refer to [[جستجو]].
...
To learn about how you can write more advanced search queries, refer to [[جستجو]].
