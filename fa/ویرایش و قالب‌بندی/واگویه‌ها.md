...
> [!info]
> Here's a callout block.
> It supports **Markdown**, [[پیوندهای درونی|Wikilinks]] and [[جاسازی پرونده‌ها|embeds]]!
> ![[og-image.png]]

<<<<<<< HEAD:fa/Editing and formatting/Callouts.md
Callouts are also supported natively on [[مقدمه ای بر ابسیدین پابلیش|Obsidian Publish]].
=======

Callouts are also supported natively on [[مقدمه‌ای بر اوبسیدین پابلیش|Obsidian Publish]].

>>>>>>> obsidianmd-master:fa/ویرایش و قالب‌بندی/واگویه‌ها.md
...
### شخصی‌سازیِ واگویه‌ها
[[تکّه‌کدهای سی‌اس‌اس]] and [[افزونه‌های انجمن]] can define custom callouts, or even overwrite the default configuration.
